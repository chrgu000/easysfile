...
## 10 华容道记录（游戏开始前调用一下该接口，传finished=0，elapsedtime=0，其他正常情况下不能提交elapsedtime值=0）
...
**两个以上参数的情况，如带share_id：**

[**http://www.gzfesco.cn/api/qcshcz/qcshczh5/authorize3/?url=www.baidu.com?pid=5&share_eid=11**](http://www.gzfesco.cn/wechat/transfer/authorize/?url=www.baidu.com?pid=3)

| **参数**  | **取值范围** | **说明**                                                     |
| --------- | ------------ | ------------------------------------------------------------ |
| URl       | 必填         | 地址，你们h5给地址，这是代表h5方获取openid的地址             |
| pid       | 必填         | 对应着项目id                                                 |
| share_eid | 必填         | 被打call者的eid，对应穿回来的nickname.headimgurl是打call者的头像和昵称 |
