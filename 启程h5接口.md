...
{"code":20000,"message":"successful connected","data":[{"nickname":"2222","openid":"xxx","headimgurl":"2","num":12,"eid":12},{"nickname":"","openid":"","headimgurl":"","num":2,"eid":6},{"nickname":"","openid":"","headimgurl":"","num":2,"eid":7},{"nickname":"","openid":"","headimgurl":"","num":1,"eid":5}]}
...
<form onsubmit="return false;">
  ...
  <input type="hidden" id="eid" name="eid" value=22>
  <input type="hidden" id="openid" name="openid" value="xxxxx">
  <input type="submit" value="submit" 				  onclick="$.post('http://www.gzfesco.cn/wechat/image/upload_base64', 			    $(this).parent().serialize(),
    function(data){
        console.log(data);
    });                           
);">
